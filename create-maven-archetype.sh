...
rm -rf ./tmp
mkdir tmp
cp -r app assets package.json gulpfile.js pom.xml tmp
pushd tmp

sed -i -e "s/am\.ik\.archetype/xxxxxx.yyyyyy.zzzzzz/g" pom.xml
sed -i -e "s/maven-reactjs-blank/projectName/g" pom.xml
sed -i -e "s/github\.com\/making\/projectName/github.com\/making\/maven-reactjs-blank/g" pom.xml
...
sed -i -e "s/projectName/maven-reactjs-blank/g" pom.xml
